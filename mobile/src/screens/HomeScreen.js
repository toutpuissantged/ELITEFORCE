...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, Image, ScrollView, TextInput, ActivityIndicator } from 'react-native';
...
const categories = [
  { id: '1', name: 'Ménage', icon: 'broom' },
  { id: '2', name: 'Plomberie', icon: 'pipe-wrench' },
  { id: '3', name: 'Électricité', icon: 'lightning-bolt' },
  { id: '4', name: 'Jardinage', icon: 'flower' },
  { id: '5', name: 'Déménagement', icon: 'truck-delivery' },
  { id: '6', name: 'Peinture', icon: 'format-paint' },
];
